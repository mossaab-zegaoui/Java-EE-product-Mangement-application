...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-7"><img class="bg-img-cover bg-center" src="assets2/images/login/2.jpg" alt="looginpage">
        </div>
                ...
                <div>
                    <div class="login-main">
                        ...
                        <p class="mt-4 mb-0 text-center">Don't have account?
                            <a class="ms-2" href="LoginController?action=registerPage">Create Account</a></p>
                    </div>
                </div>
            </div>
        </div>
